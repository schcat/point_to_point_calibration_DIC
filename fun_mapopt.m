...
parfor k=1:1:n
    ...
    imwrite(mat2gray(result), ['../image/num_train_36/simulate_speckle_patent_proj_',num2str(k),'.png']);
end
...
parfor k=1:1:n
    ...
    imwrite(mat2gray(result), ['../image/num_train_36/ROI_proj_',num2str(k),'.png']);
end
%toc
%DIC����
...
tic
mat_name = ['../result/train_num_36/speckle_map_'];
parfor k=1:1:n
...
%tic
for k = 1:1:n
    str=strcat('../result/train_num_36/speckle_map_',num2str(k),'.mat');
    load(str);
...
save(['../result/train_num_36/speckle_map.mat'],'mean_map_u','mean_map_v');
