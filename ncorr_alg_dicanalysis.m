function [displacements,rois_dic,seedinfo,outstate] = ncorr_alg_dicanalysis(imgs,radius,spacing,cutoff_diffnorm,cutoff_iteration,total_threads,enabled_stepanalysis,subsettrunc,num_img,total_imgs,params_init)
...
%                                                                                  pos_parent);
        ...
        [seedinfo_prelim,threaddiagram,outstate_seeds] = ncorr_auto_initseeds(imgs(1).imginfo, ...
                                                                                [imgs(2:end).imginfo], ...
                                                                                imgs(1).roi, ...
                                                                                radius, ...
                                                                                spacing, ...
